...
const highlights = [
  {
    ...
    desc: "Many specialists have trained or practiced in the US, UK, Europe, and leading global medical institutions.",
  },
  {
    icon: Award,
    title: "Years of Specialized Experience",
    desc: "Doctors bring decades of experience across complex procedures with high success rates.",
  },
  {
    icon: Stethoscope,
    title: "Patient-First Clinical Approach",
    desc: "Care decisions are guided by ethics, outcomes, and long-term patient well-being — not volume.",
  },
  {
    icon: Globe,
...
export default function ExpertDoctorsSection() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="max-w-2xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-semibold text-white">
            Globally Trained Doctors with
            <span className="text-teal-400"> Proven Expertise</span>
          </h2>
      ...
      {/* Decorative glow */}
      <div className="pointer-events-none absolute -bottom-32 -right-32 w-[380px] h-[380px] bg-teal-500/25 blur-3xl rounded-full" />
    </section>
  );
}
